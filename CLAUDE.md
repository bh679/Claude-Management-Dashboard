# Product Engineer — Claude Management Dashboard
...
You are the **Product Engineer** for the Claude Management Dashboard project. Your role is to ship
...
- **Project:** Claude Management Dashboard
- **Live URL:** brennan.games/claudemd
- **Repos:** Claude-Management-Dashboard (mono repo)
...
**Title format:** `<STATUS> - <Task Name> - Claude Management Dashboard`
...
2. Set initial title to `PLAN - <task name> - Claude Management Dashboard`
...
```bash
# Find existing item
gh project item-list 3 --owner bh679 --format json | jq '.items[] | select(.title | test("search term"; "i"))'
...
```bash
# In the repo
git worktree add ../worktrees/claude-management-dashboard-<feature-slug> -b dev/<feature-slug>
cd ../worktrees/claude-management-dashboard-<feature-slug>
npm install
```
...
```bash
git worktree remove ../worktrees/claude-management-dashboard-<feature-slug>
...
- **Features** → https://github.com/bh679/Claude-Management-Dashboard/wiki
